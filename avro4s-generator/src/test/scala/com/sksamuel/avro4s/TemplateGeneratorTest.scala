...
class TemplateGeneratorTest extends WordSpec with Matchers {
  ...
  "TemplateGenerator" should {
    "generate a file per enum" in {
      ...
      enums shouldBe Seq(Template("com/a/Boo.java", "//auto generated code by avro4s\npublic enum Boo{\n    A, B\n}"), Template("com/a/Foo.java", "//auto generated code by avro4s\npublic enum Foo{\n    A, B\n}"))
    }
    "generate one file for records" in {
      ...
      enums shouldBe Seq(Template("com/a/domain.scala", "//auto generated code by avro4s\ncase class Boo(\n  name: String,\n  bibble: Long\n)\n\n//auto generated code by avro4s\ncase class Foo(\n  dibble: Double,\n  bibble: Boolean\n)"))
    }
  }
}

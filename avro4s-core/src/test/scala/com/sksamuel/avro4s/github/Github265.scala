...
import com.sksamuel.avro4s.{Decoder, DecoderV2, Encoder, EncoderV2, RecordFormat, SchemaFor}
...
class Github265 extends AnyFunSuite with Matchers {
  ...
  def toAvro[T: EncoderV2 : DecoderV2](obj: T): GenericRecord = RecordFormat[T].to(obj)

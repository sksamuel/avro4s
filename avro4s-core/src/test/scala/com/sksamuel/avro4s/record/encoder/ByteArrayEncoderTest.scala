...
import com.sksamuel.avro4s.{AvroSchema, AvroSchemaV2, DefaultFieldMapper, Encoder, EncoderV2, SchemaForV2}
...
class ByteArrayEncoderTest extends AnyFunSuite with Matchers {
  ...
  test("encode byte arrays as BYTES type") {
    ...
    EncoderV2[Test].encode(Test(Array[Byte](1, 4, 9)))
  ...
  test("encode byte vectors as BYTES type") {
    ...
    val schema = AvroSchemaV2[Test]
    EncoderV2[Test].encode(Test(Vector[Byte](1, 4, 9)))
      .asInstanceOf[GenericRecord]
      .get("z")
      .asInstanceOf[ByteBuffer]
      .array().toList shouldBe List[Byte](1, 4, 9)
  ...
  test("encode byte seq as BYTES type") {
    ...
    val schema = AvroSchemaV2[Test]
    EncoderV2[Test].encode(Test(Seq[Byte](1, 4, 9)))
      .asInstanceOf[GenericRecord]
      .get("z")
      .asInstanceOf[ByteBuffer]
      .array().toList shouldBe List[Byte](1, 4, 9)
  ...
  test("encode byte list as BYTES type") {
    ...
    val schema = AvroSchemaV2[Test]
    EncoderV2[Test].encode(Test(List[Byte](1, 4, 9)))
      .asInstanceOf[GenericRecord]
      .get("z")
      .asInstanceOf[ByteBuffer]
      .array().toList shouldBe List[Byte](1, 4, 9)
  ...
  test("encode top level byte arrays") {
    ...
    EncoderV2[Array[Byte]].encode(Array[Byte](1, 4, 9))
      .asInstanceOf[ByteBuffer]
      .array().toList shouldBe List[Byte](1, 4, 9)
  }
  ...
  test("encode ByteBuffers as BYTES type") {
    ...
    val schema = AvroSchemaV2[Test]
    EncoderV2[Test].encode(Test(ByteBuffer.wrap(Array[Byte](1, 4, 9))))
      .asInstanceOf[GenericRecord]
      .get("z")
      .asInstanceOf[ByteBuffer]
      .array().toList shouldBe List[Byte](1, 4, 9)
  ...
  test("encode top level ByteBuffers") {
    ...
    EncoderV2[ByteBuffer].encode(ByteBuffer.wrap(Array[Byte](1, 4, 9)))
      .asInstanceOf[ByteBuffer]
      .array().toList shouldBe List[Byte](1, 4, 9)
  }
  ...
  test("support FIXED") {
    ...
    val fixed = EncoderV2.ByteArrayEncoder.withSchema(SchemaForV2(schema)).encode("hello".getBytes).asInstanceOf[GenericFixed]

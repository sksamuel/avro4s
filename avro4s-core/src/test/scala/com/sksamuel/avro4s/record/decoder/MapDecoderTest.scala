...
class MapDecoderTest extends AnyWordSpec with Matchers {
  "Decoder" should {
    ...
    "support top level Map[String, Test]" in {
      ...
      Decoder[Map[String, Test]].decode(enc) shouldBe data
    }
  }
}